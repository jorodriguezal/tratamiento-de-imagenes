...
/* Paralelización anidada dependiendo del número de hilos n
...
{ 
    // Init
	read_image(*(argv + 1)); // argv[1] es el path de la imagen de entrada, argv[2] es de salida. argv[3] es el número de hilos
